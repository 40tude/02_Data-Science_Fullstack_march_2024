...
* Now, to run the image, type in : ``docker run --rm -p 8000:8000 dashboard_getaround``

<p align="center">
<img src="./assets/docker_run.png" alt="drawing" width="800"/>
<p>

* You can point your favorite web browser to : `http://localhost:8000`
...
* Stop the container
    ...
    * ``docker ps``
    * `docker stop quizzical_tu` (the name will be different)
    * ``docker ps``
...
* ``./deploy_dashboard_getaround.ps1`` (type ``./de`` then strike TAB, Powershell is your friend)

* Point your favorite web browser to : `https://dashboard-getaround-ab69d6a429e9.herokuapp.com/` (the URL will be different)
